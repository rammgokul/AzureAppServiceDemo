...
RUN dotnet restore "./Insight_Demo.csproj"

# Compile, then pack the compiled app and dependencies into a deployable unit.
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-publish?tabs=netcore21
RUN dotnet publish "Insight_Demo.csproj" -c Release -o /app/publish
...
# To run the app, run `dotnet Insight_Demo.dll`, which we just copied over.
ENTRYPOINT ["dotnet", "Insight_Demo.dll"]